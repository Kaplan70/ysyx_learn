...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"select", false,-1, 2,0);
    ...
    tracep->declBus(c+7,"bs", false,-1, 3,0);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,(vlSelf->alu__DOT__out),4);
    bufp->fullCData(oldp+7,((0xfU & ((IData)(1U) + 
                                     (~ (IData)(vlSelf->b))))),4);
    bufp->fullBit(oldp+8,((1U & (~ (IData)((0U != (IData)(vlSelf->alu__DOT__out)))))));
