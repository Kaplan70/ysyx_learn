...
void Valu___024root__trace_chg_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+5,(vlSelf->alu__DOT__out),4);
    bufp->chgCData(oldp+6,((0xfU & ((IData)(1U) + (~ (IData)(vlSelf->b))))),4);
    bufp->chgBit(oldp+7,((1U & (~ (IData)((0U != (IData)(vlSelf->alu__DOT__out)))))));
}
